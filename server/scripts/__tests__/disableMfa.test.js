...
describe("disable-mfa.js (subprocess)", () => {
  // Final-Codex FLAG fix: the script refuses non-TTY stdin
  // unless VS_RECOVERY_AUTOCONFIRM=1 is set explicitly. The
  // jest harness can't fake a real TTY without conpty/node-pty,
  // so we test the non-TTY contract directly.
